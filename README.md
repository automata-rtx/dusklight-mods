...
survive game updates without a rebuild). Realtime Sun Shadows, Deferred Fog, and Unbaked Vertex
Lighting are **game-linked** (they hook game functions, so they are coupled to the pinned game
build). Realtime Sun Shadows
